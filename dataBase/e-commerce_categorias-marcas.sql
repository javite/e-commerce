...
CREATE TABLE `categorias-marcas` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_test` (`categorias_id`),
  CONSTRAINT `fk_test` FOREIGN KEY (`categorias_id`) REFERENCES `categorias` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-10-25 11:01:25
